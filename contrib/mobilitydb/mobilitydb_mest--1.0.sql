...
CREATE FUNCTION spanset_mest_span_options(internal)
  RETURNS void
  AS 'MODULE_PATHNAME'
  LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION spanset_mest_seg_options(internal)
  RETURNS void
  AS 'MODULE_PATHNAME', 'Spanset_mest_seg_options'
  LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION intspanset_mest_bin_options(internal)
  RETURNS void
  AS 'MODULE_PATHNAME', 'Intspanset_mest_bin_options'
  LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;
CREATE FUNCTION floatspanset_mest_bin_options(internal)
  RETURNS void
  AS 'MODULE_PATHNAME', 'Floatspanset_mest_bin_options'
  LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION timespanset_mest_bin_options(internal)
  RETURNS void
  AS 'MODULE_PATHNAME', 'Timespanset_mest_bin_options'
  LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;
...
CREATE FUNCTION spanset_mest_equisplit(internal, internal, internal)
  RETURNS bool
  AS 'MODULE_PATHNAME', 'Spanset_mest_equisplit'
  LANGUAGE C IMMUTABLE STRICT;

CREATE OPERATOR CLASS intspanset_mrtree_equisplit_ops
...
CREATE OPERATOR CLASS bigintspanset_mrtree_equisplit_ops
...
CREATE OPERATOR CLASS floatspanset_mrtree_equisplit_ops
...
CREATE OPERATOR CLASS datespanset_mrtree_equisplit_ops
...
CREATE OPERATOR CLASS tstzspanset_mrtree_equisplit_ops
...
CREATE FUNCTION spanset_mest_segsplit(internal, internal, internal)
  RETURNS bool
  AS 'MODULE_PATHNAME', 'Spanset_mest_segsplit'
  LANGUAGE C IMMUTABLE STRICT;

CREATE OPERATOR CLASS intspanset_mrtree_segsplit_ops
  FOR TYPE intspanset USING mgist AS
  STORAGE intspan,
  -- strictly left
  OPERATOR  1     << (intspanset, integer),
  OPERATOR  1     << (intspanset, intspan),
...
CREATE OPERATOR CLASS bigintspanset_mrtree_segsplit_ops
  FOR TYPE bigintspanset USING mgist AS
  STORAGE bigintspan,
  -- strictly left
  OPERATOR  1     << (bigintspanset, bigint),
  OPERATOR  1     << (bigintspanset, bigintspan),
...
CREATE OPERATOR CLASS floatspanset_mrtree_segsplit_ops
  FOR TYPE floatspanset USING mgist AS
  STORAGE floatspan,
  -- strictly left
  OPERATOR  1     << (floatspanset, float),
  OPERATOR  1     << (floatspanset, floatspan),
...
CREATE OPERATOR CLASS datespanset_mrtree_segsplit_ops
  FOR TYPE datespanset USING mgist AS
  STORAGE datespan,
  -- overlaps
  OPERATOR  3    && (datespanset, datespan),
  OPERATOR  3    && (datespanset, datespanset),
...
CREATE OPERATOR CLASS tstzspanset_mrtree_segsplit_ops
  FOR TYPE tstzspanset USING mgist AS
  STORAGE tstzspan,
  -- overlaps
  OPERATOR  3    && (tstzspanset, tstzspan),
  OPERATOR  3    && (tstzspanset, tstzspanset),
...
CREATE FUNCTION intspanset_mest_binsplit(internal, internal, internal)
  RETURNS bool
  AS 'MODULE_PATHNAME', 'Intspanset_mest_binsplit'
  LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION bigintspanset_mest_binsplit(internal, internal, internal)
  RETURNS bool
  AS 'MODULE_PATHNAME', 'Bigintspanset_mest_binsplit'
  LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION floatspanset_mest_binsplit(internal, internal, internal)
  RETURNS bool
  AS 'MODULE_PATHNAME', 'Floatspanset_mest_binsplit'
  LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION timespanset_mest_binsplit(internal, internal, internal)
  RETURNS bool
  AS 'MODULE_PATHNAME', 'Timespanset_mest_binsplit'
  LANGUAGE C IMMUTABLE STRICT;

CREATE OPERATOR CLASS intspanset_mrtree_binsplit_ops
  FOR TYPE intspanset USING mgist AS
  STORAGE intspan,
  -- strictly left
  OPERATOR  1     << (intspanset, integer),
...
CREATE OPERATOR CLASS bigintspanset_mrtree_binsplit_ops
  FOR TYPE bigintspanset USING mgist AS
  STORAGE bigintspan,
  -- strictly left
  OPERATOR  1     << (bigintspanset, bigint),
...
CREATE OPERATOR CLASS floatspanset_mrtree_binsplit_ops
  FOR TYPE floatspanset USING mgist AS
  STORAGE floatspan,
  -- strictly left
  OPERATOR  1     << (floatspanset, float),
...
CREATE OPERATOR CLASS datespanset_mrtree_binsplit_ops
  FOR TYPE datespanset USING mgist AS
  STORAGE datespan,
  -- overlaps
  OPERATOR  3    && (datespanset, datespan),
...
CREATE OPERATOR CLASS tstzspanset_mrtree_binsplit_ops
  FOR TYPE tstzspanset USING mgist AS
  STORAGE tstzspan,
  -- overlaps
  OPERATOR  3    && (tstzspanset, tstzspan),
...
CREATE OPERATOR CLASS intspanset_mquadtree_equisplit_ops
  ...
  FUNCTION  7  spanset_mest_span_options(internal),
  FUNCTION  8  spanset_mest_equisplit(internal, internal, internal);

/******************************************************************************/

CREATE OPERATOR CLASS bigintspanset_mquadtree_equisplit_ops
...
CREATE OPERATOR CLASS floatspanset_mquadtree_equisplit_ops
...
CREATE OPERATOR CLASS datespanset_mquadtree_equisplit_ops
...
CREATE OPERATOR CLASS tstzspanset_mquadtree_equisplit_ops
...
CREATE OPERATOR CLASS intspanset_mkdtree_equisplit_ops
...
CREATE OPERATOR CLASS bigintspanset_mkdtree_equisplit_ops
...
CREATE OPERATOR CLASS floatspanset_mkdtree_equisplit_ops
...
CREATE OPERATOR CLASS datespanset_mkdtree_equisplit_ops
...
CREATE OPERATOR CLASS tstzspanset_mkdtree_equisplit_ops
...
CREATE OPERATOR CLASS intspanset_mquadtree_segsplit_ops
  FOR TYPE intspanset USING mspgist AS
  STORAGE intspan,
  -- strictly left
  OPERATOR  1     << (intspanset, integer),
  ...
  FUNCTION  5  spanset_mspgist_leaf_consistent(internal, internal),
  FUNCTION  6  spanset_mspgist_compress(internal),
  FUNCTION  7  spanset_mest_seg_options(internal),
  FUNCTION  8  spanset_mest_segsplit(internal, internal, internal);

/******************************************************************************/

CREATE OPERATOR CLASS bigintspanset_mquadtree_segsplit_ops
  FOR TYPE bigintspanset USING mspgist AS
  STORAGE bigintspan,
  -- strictly left
  OPERATOR  1     << (bigintspanset, bigint),
...
CREATE OPERATOR CLASS floatspanset_mquadtree_segsplit_ops
  FOR TYPE floatspanset USING mspgist AS
  STORAGE floatspan,
  -- strictly left
  OPERATOR  1     << (floatspanset, float),
...
CREATE OPERATOR CLASS datespanset_mquadtree_segsplit_ops
  FOR TYPE datespanset USING mspgist AS
  STORAGE datespan,
  -- overlaps
  OPERATOR  3    && (datespanset, datespan),
...
CREATE OPERATOR CLASS tstzspanset_mquadtree_segsplit_ops
  FOR TYPE tstzspanset USING mspgist AS
  STORAGE tstzspan,
  -- overlaps
  OPERATOR  3    && (tstzspanset, tstzspan),
...
CREATE OPERATOR CLASS intspanset_mkdtree_segsplit_ops
  FOR TYPE intspanset USING mspgist AS
  STORAGE intspan,
  -- strictly left
  OPERATOR  1     << (intspanset, integer),
...
CREATE OPERATOR CLASS bigintspanset_mkdtree_segsplit_ops
  FOR TYPE bigintspanset USING mspgist AS
  STORAGE bigintspan,
  -- strictly left
  OPERATOR  1     << (bigintspanset, bigint),
...
CREATE OPERATOR CLASS floatspanset_mkdtree_segsplit_ops
  FOR TYPE floatspanset USING mspgist AS
   STORAGE floatspan,
 -- strictly left
  OPERATOR  1     << (floatspanset, float),
...
CREATE OPERATOR CLASS datespanset_mkdtree_segsplit_ops
  FOR TYPE datespanset USING mspgist AS
  STORAGE datespan,
  -- overlaps
  OPERATOR  3    && (datespanset, datespan),
...
CREATE OPERATOR CLASS tstzspanset_mkdtree_segsplit_ops
  FOR TYPE tstzspanset USING mspgist AS
  STORAGE tstzspan,
  -- overlaps
  OPERATOR  3    && (tstzspanset, tstzspan),
...
CREATE OPERATOR CLASS intspanset_mquadtree_binsplit_ops
  FOR TYPE intspanset USING mspgist AS
  STORAGE intspan,
  -- strictly left
  OPERATOR  1     << (intspanset, integer),
  ...
  FUNCTION  5  spanset_mspgist_leaf_consistent(internal, internal),
  FUNCTION  6  spanset_mspgist_compress(internal),
  FUNCTION  7  intspanset_mest_bin_options(internal),
  FUNCTION  8  intspanset_mest_binsplit(internal, internal, internal);

/******************************************************************************/

CREATE OPERATOR CLASS bigintspanset_mquadtree_binsplit_ops
  FOR TYPE bigintspanset USING mspgist AS
  STORAGE bigintspan,
  -- strictly left
  OPERATOR  1     << (bigintspanset, bigint),
  ...
  FUNCTION  6  spanset_mspgist_compress(internal),
  FUNCTION  7  intspanset_mest_bin_options(internal),
  FUNCTION  8  bigintspanset_mest_binsplit(internal, internal, internal);

/******************************************************************************/

CREATE OPERATOR CLASS floatspanset_mquadtree_binsplit_ops
  FOR TYPE floatspanset USING mspgist AS
  STORAGE floatspan,
  -- strictly left
  OPERATOR  1     << (floatspanset, float),
  ...
  FUNCTION  5  spanset_mspgist_leaf_consistent(internal, internal),
  FUNCTION  6  spanset_mspgist_compress(internal),
  FUNCTION  7  floatspanset_mest_bin_options(internal),
  FUNCTION  8  floatspanset_mest_binsplit(internal, internal, internal);

/******************************************************************************/

CREATE OPERATOR CLASS datespanset_mquadtree_binsplit_ops
  FOR TYPE datespanset USING mspgist AS
  STORAGE datespan,
  -- overlaps
  OPERATOR  3    && (datespanset, datespan),
  ...
  FUNCTION  5  spanset_mspgist_leaf_consistent(internal, internal),
  FUNCTION  6  spanset_mspgist_compress(internal),
  FUNCTION  7  timespanset_mest_bin_options(internal),
  FUNCTION  8  timespanset_mest_binsplit(internal, internal, internal);

/******************************************************************************/

CREATE OPERATOR CLASS tstzspanset_mquadtree_binsplit_ops
  FOR TYPE tstzspanset USING mspgist AS
  STORAGE tstzspan,
  -- overlaps
  OPERATOR  3    && (tstzspanset, tstzspan),
...
CREATE OPERATOR CLASS intspanset_mkdtree_binsplit_ops
  FOR TYPE intspanset USING mspgist AS
  STORAGE intspan,
  -- strictly left
  OPERATOR  1     << (intspanset, integer),
...
CREATE OPERATOR CLASS bigintspanset_mkdtree_binsplit_ops
  FOR TYPE bigintspanset USING mspgist AS
  STORAGE bigintspan,
  -- strictly left
  OPERATOR  1     << (bigintspanset, bigint),
...
CREATE OPERATOR CLASS floatspanset_mkdtree_binsplit_ops
  FOR TYPE floatspanset USING mspgist AS
   STORAGE floatspan,
 -- strictly left
  OPERATOR  1     << (floatspanset, float),
...
CREATE OPERATOR CLASS datespanset_mkdtree_binsplit_ops
  FOR TYPE datespanset USING mspgist AS
  STORAGE datespan,
  -- overlaps
  OPERATOR  3    && (datespanset, datespan),
...
CREATE OPERATOR CLASS tstzspanset_mkdtree_binsplit_ops
  FOR TYPE tstzspanset USING mspgist AS
  STORAGE tstzspan,
  -- overlaps
  OPERATOR  3    && (tstzspanset, tstzspan),
