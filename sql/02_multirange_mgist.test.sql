...
DROP INDEX IF EXISTS tbl_int4multirange_mrtree_idx;
DROP INDEX IF EXISTS tbl_int8multirange_mrtree_idx;
DROP INDEX IF EXISTS tbl_datemultirange_mrtree_idx;
DROP INDEX IF EXISTS tbl_tstzmultirange_mrtree_idx;

DROP INDEX IF EXISTS tbl_int4multirange_mrtree_opts_idx;
DROP INDEX IF EXISTS tbl_int8multirange_mrtree_opts_idx;
DROP INDEX IF EXISTS tbl_datemultirange_mrtree_opts_idx;
DROP INDEX IF EXISTS tbl_tstzmultirange_mrtree_opts_idx;
...
CREATE INDEX tbl_int4multirange_mrtree_idx ON tbl_int4multirange USING MGIST(i);
CREATE INDEX tbl_int8multirange_mrtree_idx ON tbl_int8multirange USING MGIST(b);
CREATE INDEX tbl_datemultirange_mrtree_idx ON tbl_datemultirange USING MGIST(d);
CREATE INDEX tbl_tstzmultirange_mrtree_idx ON tbl_tstzmultirange USING MGIST(t);

-------------------------------------------------------------------------------

UPDATE test_multirange_mgist SET mrtree_idx = ( SELECT COUNT(*)
FROM tbl_int4range t1, tbl_int4multirange t2 WHERE t1.i @> t2.i )
...
DROP INDEX tbl_int4multirange_mrtree_idx;
DROP INDEX tbl_int8multirange_mrtree_idx;
DROP INDEX tbl_datemultirange_mrtree_idx;
DROP INDEX tbl_tstzmultirange_mrtree_idx;
...
UPDATE test_multirange_mgist SET mrtree_opts_idx = ( SELECT COUNT(*)
FROM tbl_int4range t1, tbl_int4multirange t2 WHERE t1.i @> t2.i )
WHERE op = '@>' AND leftarg = 'int4range' AND rightarg = 'int4multirange';
UPDATE test_multirange_mgist SET mrtree_opts_idx = ( SELECT COUNT(*)
FROM tbl_int4multirange t1, tbl_int t2 WHERE t1.i @> t2.i )
...
DROP INDEX tbl_int4multirange_mrtree_opts_idx;
DROP INDEX tbl_int8multirange_mrtree_opts_idx;
DROP INDEX tbl_datemultirange_mrtree_opts_idx;
DROP INDEX tbl_tstzmultirange_mrtree_opts_idx;
