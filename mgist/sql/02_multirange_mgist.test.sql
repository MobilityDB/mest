...
CREATE INDEX tbl_int4multirange_mgist_idx ON tbl_int4multirange USING GIST(i);
CREATE INDEX tbl_int8multirange_mgist_idx ON tbl_int8multirange USING GIST(b);
CREATE INDEX tbl_datespanset_mgist_idx ON tbl_datemultirange USING GIST(d);
CREATE INDEX tbl_tstzmultirange_mgist_idx ON tbl_tstzmultirange USING GIST(t);
