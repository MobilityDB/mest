...
typedef struct MSpGistScanOpaqueData
{
  ...
  struct stidtable_hash *tidtable;   /* hash table of TID's */
  struct stidisttable_hash *tidisttable; /* hash table of TID's storing 
 ...
 * The hashtable entries are represented by this data structure.
 */
typedef struct STIDISTTableEntry
{
    ItemPointerData   tid;            /* TID (hashtable key) */
